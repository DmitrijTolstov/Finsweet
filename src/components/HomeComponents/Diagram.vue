        ...
        <div class="container">
            <div class="donation-container">
                <div class="donation-content">
                    <h2 class="donation-content__title">
                        How we spend your donations and where it goes
                    </h2>
                    <p class="donation-content__text">
                    ...
                    <ul class="donation-content__procents">
        ...
        &__procents{
            ...
            li{
                ...
                &:nth-child(1){
                    position: relative;
               &::before{
                @include square($secondary-green)
               }
            }
            &:nth-child(2){
                    position: relative;
               &::before{
                @include square(#AC94F1)
               }
            }
            &:nth-child(3){
                    position: relative;
                    margin-right: 0;
               &::before{
                @include square(#FFF0CA)
               }
            }
            &:nth-child(4){
                    position: relative;
               &::before{
                @include square(#F9CF64)
               }
            }
            &:nth-child(5){
                    position: relative;
               &::before{
                @include square(#F38FBF)
               }
            }
            }
